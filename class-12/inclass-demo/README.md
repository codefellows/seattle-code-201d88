...
- Array of pics of goats

#### Dom References

- Grab HTML elements that shows the pictures of goats - imgs
...
- Goat Objects
  - Properties
    ...
    - name
    - img of the goats - path
  - Array to store our goats
...
- Random img generator - randomly generate our indexes
...
- Event Listeners!
  ...
  - click - "button" after 15 rounds show results
